...
G4cout<<"Construct function in run.cc ********************************** "<<G4endl;
...
{ 
  ...
  fParticle = particle;
  fEkin = energy;
G4cout<<"Run::SetPrimary in run.cc ********************************** "<<G4endl;
...
{
G4cout<<"Run::CountProcesses11111111111111 in run.cc ********************************** "<<G4endl;
  ...
  G4cout<<"Run::CountProcesses in run.cc ********************************** "<<G4endl;
}
...
G4cout<<"Run::Merge in run.cc ********************************** "<<G4endl;
