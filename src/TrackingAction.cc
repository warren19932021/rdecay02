...
G4cout<<"TrackingAction::PreUserTrackingAction ************************************"<<G4endl;
  ...
  if (lVolume == fDetector->GetLogicDetector()) iVol = 2;
    std::cout << "Andi Test 01" << std::endl;
  //secondary particles only
  if (track->GetTrackID() == 1) return;
  std::cout << "Andi Test 011" << std::endl;
  ...
  std::cout << "Andi Test 02" << std::endl;
  ...
  std::cout << "Andi Test 03" << std::endl;
  ...
  std::cout << "Andi Test 04" << std::endl;
}
